<?php 
if(!empty($data->id)){
    $url = route(guardName().'.sub-category.update', [$data->id]);
    $submit_button = 'Update Sub Category';
}else{    
    $url = route(guardName().'.sub-category.store');
    $submit_button = 'Create Sub Category';
}
?>
