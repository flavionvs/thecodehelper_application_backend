...
<div class="app-content">
  ...
  <div class="row">
    <div class="col-sm-6 col-lg-6 col-xl-3">
      <div class="card">
        <div class="card-body iconfont text-left">
          <h6 class="mb-3">Renewed Users</h6>
          <h2 class="mb-1 text-dark display-4 font-weight-bold">19.89K<span class="text-success fs-13 ml-2">(+25%)</span></h2>
    ...
    <div class="col-sm-6 col-lg-6 col-xl-3">
      <div class="card">
        <div class="card-body iconfont text-left">
          ...
          <h2 class="mb-1 text-dark display-4 font-weight-bold">692<span class="text-success fs-13 ml-2">(+15%)</span></h2>
          <p class="mb-3">Overview of Last month</p>
          <div class="progress h-1 mb-2">
    ...
    <div class="col-sm-6 col-lg-6 col-xl-3">
      <div class="card">
        <div class="card-body iconfont text-left">
          <h6 class="mb-3">Churned Users</h6>
          <h2 class="mb-1 text-dark display-4 font-weight-bold">286<span class="text-success fs-13 ml-2">(+08%)</span></h2>
          <p class="mb-3">Overview of Last month</p>
          <div class="progress h-1 mb-2">
    ...
    <div class="col-sm-6 col-lg-6 col-xl-3">
      <div class="card">
        <div class="card-body iconfont text-left">
          ...
          <h2 class="mb-1 text-dark display-4 font-weight-bold">$2.98M<span class="text-success fs-13 ml-2">(+35%)</span></h2>
          <p class="mb-3">Overview of Last month</p>
          <div class="progress h-1 mb-2">
  ...
  <div class="row">
    <div class="col-lg-6">
            ...
            <div class="card-body">
              <div class="d-flex">
                <div class="">
                  ...
                  <h2 class="mt-2 mb-2 display-6 font-weight-bold">$345.89K</h2>
                  <span class="mb-0 text-muted"><i class="fa fa-caret-down text-danger mr-1"></i> 12% last month</span>
                </div>
                <div class="ml-auto mt-3">
                  <span class="pie" data-peity='{ "fill": ["#564ec1", "#e2e1ea"]}'>280/360</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="d-flex">
                <div class="">
                  ...
                  <h2 class="mt-2 mb-2 display-6 font-weight-bold">$256.8K</h2>
                  <span class="mb-0 text-muted"><i class="fa fa-caret-up text-success mr-1"></i> 24% last month</span>
                </div>
                <div class="ml-auto mt-3">
                  <span class="pie" data-peity='{ "fill": ["#04cad0", "#e2e1ea"]}'>220/360</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card overflow-hidden">
        <div class="card-body pb-0">
          <div class="h3 text-left mb-1">Net Retention (this week)</div>
          <p class="text-muted text-left mb-4">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque</p>
          <div class="row text-left">
            <div class="col dash-1">
              <p class="mb-0 font-weight-semibold">Cancel</p>
              <h2 class="mb-0">$6.8K</h2>
            </div>
            <div class="col dash-1">
              <p class="mb-0 font-weight-semibold">Expansion</p>
              <h2 class="mb-0">$4.74K</h2>
            </div>
            <div class="col">
              <p class="mb-0 font-weight-semibold">Contraction</p>
              <h2 class="mb-0">$2.8K</h2>
            </div>
          </div>
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-body">
          <h3 class="mb-1">Key Conversion Metrics</h3>
          <p class="text-muted mb-4">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque</p>
          <div class="row mb-5">
            <div class="col-sm-4 dash-1">
              <h2 class="mb-0 text-primary">67.39%</h2>
              <span class="font-weight-semibold mb-0">Lead to Trial</span>
            </div>
            <div class="col-sm-4 dash-1">
              <h2 class="mb-0 text-secondary">59.78%</h2>
              <span class="font-weight-semibold mb-0">Web User to Trial</span>
            </div>
            <div class="col-sm-4">
              <h2 class="mb-0 text-danger">45.38%</h2>
              <span class="font-weight-semibold mb-0">Web User to Lead</span>
            </div>
          </div>
          <div class="chart-wrapper">
